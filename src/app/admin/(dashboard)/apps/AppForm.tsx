...
export default function AppForm({ initialData }: { initialData?: any }) {
  ...
  return (
    <form action={saveApplication} className="max-w-4xl space-y-8 pb-20">
      ...
      <div className="space-y-6">
        ...
        <div>
          <label className="block text-sm font-medium mb-2">Screenshot Gallery</label>
          <ScreenshotManager initialScreenshots={initialData?.screenshots} />
        </div>
      </div>
      ...
      <div className="flex gap-4 pt-4 border-t dark:border-zinc-800">
        <SubmitButton>Save Application</SubmitButton>
